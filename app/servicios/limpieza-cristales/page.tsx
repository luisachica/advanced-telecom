...
// Datos específicos del servicio - Adaptados para "Limpieza de Cristales"
const serviceData = {
  title: "Limpieza de cristales",
  description: "Servicios profesionales de limpieza de cristales para hogares y negocios en Madrid",
  heroImage: "/images/limpieza-cristales-en-madrid.webp", // Nueva imagen de héroe
  icon: <Sparkles className="h-6 w-6" />, // Icono de brillo/limpieza
  ...
  features: [
    {
      ...
      description: "Cristales sin marcas ni residuos, con un brillo duradero.",
      icon: <Sparkles className="h-6 w-6" />,
    },
    {
      title: "Profesionales experimentados",
      description: "Equipo cualificado y con experiencia en limpieza de cristales de todo tipo y altura.",
      icon: <Users className="h-6 w-6" />,
    },
    {
      title: "Equipos especializados",
      description: "Utilizamos herramientas y sistemas de seguridad adecuados para cada trabajo, incluyendo trabajos en altura.",
      icon: <Wrench className="h-6 w-6" />, // Icono de herramientas
    },
    {
      title: "Productos seguros",
      description: "Empleamos productos específicos para cristales, que son respetuosos con el medio ambiente y no dejan residuos.",
  ...
  process: [
    {
      ...
      description: "Visitamos tu ubicación para evaluar el tipo y la altura de los cristales, y te ofrecemos un presupuesto ajustado.",
    },
    {
      title: "Planificación del servicio",
      description: "Acordamos el horario que mejor se adapte a ti, minimizando cualquier interrupción.",
    },
    {
      title: "Preparación y seguridad",
      description: "Implementamos todas las medidas de seguridad necesarias para proteger tanto a nuestro equipo como tu propiedad.",
    },
    {
      title: "Limpieza profesional",
      description:
        "Nuestro equipo ejecuta la limpieza con precisión, utilizando las técnicas y productos adecuados para cada superficie.",
    },
    {
      title: "Revisión final",
      description: "Realizamos una inspección detallada para asegurar que cada cristal esté perfectamente limpio y brillante.",
    },
  ],
  faqs: [
    {
      question: "¿Qué tipos de cristales limpian?",
      answer:
        "Limpiamos todo tipo de cristales: ventanas, escaparates, espejos, mamparas, techos acristalados, fachadas de cristal y más, tanto en interiores como exteriores. Nos adaptamos a cualquier tamaño y altura.",
    },
    {
      question: "¿Cómo garantizan que no queden marcas?",
      answer:
        "Utilizamos técnicas de limpieza profesionales, agua desmineralizada, herramientas específicas como raquetas y bayetas de microfibra de alta calidad, y productos anti-marcas. Nuestro personal está capacitado para asegurar un acabado impecable.",
    },
    {
      question: "¿Pueden limpiar cristales de difícil acceso o en altura?",
      answer:
        "Sí, estamos equipados y certificados para realizar trabajos de limpieza de cristales en altura y de difícil acceso, utilizando pértigas, plataformas elevadoras o sistemas de descuelgue vertical, siempre bajo estrictas normas de seguridad.",
    },
    {
      question: "¿Con qué frecuencia debo limpiar mis cristales?",
      answer:
        "La frecuencia ideal depende del entorno y el uso. Para negocios o zonas de alto tránsito, recomendamos limpiezas semanales o quincenales. Para hogares, cada uno o tres meses suele ser suficiente para mantenerlos brillantes.",
    },
  ],
  testimonials: [
    {
      stars: 5,
      text: "Mis ventanas nunca estuvieron tan limpias. El equipo fue muy rápido y profesional, dejando un brillo espectacular.",
      name: "Ana S.",
    ...
    {
      stars: 5,
      text: "Contratamos sus servicios para la limpieza de los escaparates de nuestra tienda y el resultado es excelente. ¡Totalmente recomendados!",
      name: "Roberto G.",
      company: "Tienda de Ropa",
      date: "28 Marzo 2024",
      initial: "R",
    },
    {
      stars: 5,
      text: "Impresionante trabajo en los cristales de mi terraza, que estaban muy sucios. Ahora lucen como nuevos.",
      name: "Elena F.",
      company: "Apartamento",
      date: "5 Mayo 2024",
      initial: "E",
  ...
  galleryImages: [
    {
      src: "/images/limpieza-cristales-en-madrid.webp",
      alt: "Profesional limpiando cristales de una oficina",
      width: 800,
      height: 600,
    },
    {
      src: "/images/limpieza-cristales-interior.webp",
      alt: "Limpieza de cristales interiores",
      width: 400,
      height: 400,
    },
    {
      src: "/images/limpieza-cristales-altura.webp",
      alt: "Limpieza de cristales en altura con pértiga",
      width: 400,
      height: 400,
    },
    {
      src: "/images/limpieza-cristales-empresas.webp",
      alt: "Limpieza de ventanas en un empresas",
      width: 400,
      height: 400,
    },
  ],
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  >
                    <a
                      href="https://wa.me/34608305354?text=Hola%2C%20quiero%20más%20informaci%C3%B3n%20sobre%20limpieza%20de%20cristales"
                      target="_blank"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-[#00b3d7] pl-4 italic text-[#5a7184]">
                  "Brindamos claridad y brillo a tus espacios con un servicio de limpieza de cristales sin igual, adaptado a tus necesidades específicas."
                </div>
                <p className="text-[#5a7184]">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {[
                    "Limpieza de ventanas y ventanales",
                    "Limpieza de escaparates y puertas de cristal",
                    "Limpieza de mamparas de baño y divisiones de cristal",
                    "Limpieza de espejos y superficies acristaladas",
                    "Eliminación de manchas de cal, suciedad y residuos",
                    "Limpieza de cristales en altura (con equipo especializado)",
                  ].map((item, index) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="rounded-2xl overflow-hidden shadow-md">
                    <Image
                      src={validateImagePath("/images/limpieza-cristales-interior.webp") || "/placeholder.svg"}
                      alt="Limpieza de cristales en interiores"
                      width={300}
                      height={400}
                      className="w-full h-auto object-cover"
                    />
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-md">
                    <Image
                      src={validateImagePath("/images/limpieza-cristales-altura.webp") || "/placeholder.svg"}
                      alt="Limpiador profesional de cristales"
                      width={300}
                      height={200}
                      className="w-full h-auto object-cover"
                    />
                ...
                <div className="mt-12">
                  <div className="rounded-2xl overflow-hidden shadow-md">
                    <Image
                      src={validateImagePath("/images/limpieza-cristales-en-madrid.webp") || "/placeholder.svg"}
                      alt="Servicio de limpieza de cristales"
                      width={300}
                      height={500}
                      className="w-full h-auto object-cover"
                    />
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">
                Seguimos un proceso estructurado para garantizar un servicio de calidad y cristales impecables.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                  ¿Listo para disfrutar de cristales impecables?
                </h2>
                <p className="text-white/90 text-lg">
                  Solicita un presupuesto sin compromiso y descubre cómo nuestro servicio de{" "}
                  {serviceData.title.toLowerCase()} puede transformar la claridad de tu espacio.
                </p>
                <div className="flex flex-wrap gap-4 pt-6">
                  <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20cristales">
