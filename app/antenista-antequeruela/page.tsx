...
export const metadata: Metadata = {
  title: `Antenista en Antequeruela Toledo | ☎️ 668 67 95 00`,
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-xl text-brand-black-light leading-relaxed">
                      Prestamos servicio de antenista en el histórico barrio de Antequeruela, situado en la ladera sur del Alcázar de Toledo. Un barrio de calles empedradas y casas con siglos de historia que requieren una instalación de telecomunicaciones especializada y respetuosa con el patrimonio. Atendemos viviendas, casas restauradas y alojamientos turísticos con la mayor profesionalidad.
                    </p>
                  </div>
                ...
                <div className="relative">
                  <div className="mt-20 flex justify-center relative overflow-hidden rounded-xl">
                    <Image src="/images/telecom/antenistas-en-toledo-sur.jpg" alt="Antenista profesional en Antequeruela Toledo" width={400} height={200} priority />
                  </div>
                </div>
              </div>
            </div>
