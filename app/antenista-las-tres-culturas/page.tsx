...
const municipioData = {
  nombre: "Las Tres Culturas",
  slug: "las-tres-culturas",
  provincia: "Toledo",
  ...
  zonasCubiertas: [
    ...
    "Equipamientos y servicios del barrio"
  ],
  cobertura: [
    { zona: "Barrio Las Tres Culturas", disponible: true },
    { zona: "Bloques residenciales de la zona", disponible: true },
    { zona: "Comunidades de propietarios", disponible: true },
    { zona: "Equipamientos y servicios del barrio", disponible: true }
  ],
  testimonios: [
    {
  ...
  caracteristicas: [
    ...
    },
    {
      ...
      descripcion: "Solo trabajamos con componentes certificados de las mejores marcas del sector.",
      icono: "Shield"
    },
    {
      titulo: "Presupuesto Transparente",
      descripcion: "Siempre entregamos presupuesto cerrado y por escrito antes de comenzar.",
      icono: "Eye"
    },
    {
...
export const metadata: Metadata = {
  title: `Antenista en Las Tres Culturas Toledo | ☎️ 668 67 95 00`,
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1">
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                <div className="space-y-8">
                  <nav className="flex items-center space-x-2 text-sm text-brand-black-light">
                    ...
                    <span>/</span>
                    <span className="text-brand-green font-medium">Las Tres Culturas</span>
                  </nav>
                ...
                <div className="relative">
                  <div className="mt-20 flex justify-center relative overflow-hidden rounded-xl">
                    <Image src="/images/telecom/antenistas-en-toledo-sur.jpg" alt="Antenista profesional en Las Tres Culturas Toledo" width={400} height={200} priority />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-brand-green/5 to-white rounded-xl p-8 shadow-lg border border-brand-green/20">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-semibold text-brand-black">Zonas de cobertura en Las Tres Culturas</h3>
                  ...
                  <div className="p-4 bg-brand-green/10 rounded-lg">
                    <div className="flex items-center text-brand-green font-medium">
                      ...
                      <span>Servicio urgente con asistencia en menos de 2 horas en Las Tres Culturas.</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="py-16 md:py-24 bg-white">
            <div className="container mx-auto px-4 md:px-6">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-brand-black mb-4">La confianza de nuestros clientes en Las Tres Culturas</h2>
                <p className="text-xl text-brand-black-light max-w-3xl mx-auto">Vecinos y comunidades satisfechos con nuestro servicio en el barrio.</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
