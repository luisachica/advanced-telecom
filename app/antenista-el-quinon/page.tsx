...
export const metadata: Metadata = {
  title: `Antenista en El Quiñón | Antenas Toledo`,
  ...
  keywords: `antenista El Quiñón, antenas comunitarias El Quiñón, TDT El Quiñón, videoporteros El Quiñón, filtros 5G El Quiñón, reparación antenas `,
  alternates: {
    canonical: 'https://antenastoledo.com/antenista-el-quinon'
  },
  robots: {
    index: true,
    follow: true,
