...
export const metadata: Metadata = {
  title: `Antenista en Los Palominos | Antenas Toledo`,
  ...
  alternates: {
    canonical: 'https://antenastoledo.com/antenista-los-palominos'
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: 'Antenista en Los Palominos | Antenas Toledo',
    description: '✅ Tu antenista en la urbanización Los Palominos. Damos solución a problemas de TDT y parabólicas en tu chalet. Presupuesto gratuito y servicio rápido.',
    url: 'https://antenastoledo.com/antenista-los-palominos',
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button asChild className="bg-white text-brand-green hover:bg-gray-100 rounded-full px-8 py-6">
                      <a href="https://wa.me/34668679500?text=Hola%2C%20necesito%20un%20antenista%20en%20Los%20Palominos" className="flex items-center gap-2">
