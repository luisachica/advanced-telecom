...
const municipioData = {
  ...
  caracteristicas: [
    ...
    },
    {
      ...
      descripcion: "Solo utilizamos materiales de primeras marcas y componentes homologados por la UE.",
      icono: "Shield"
    },
    {
  ...
  faqs: [
    ...
    {
      question: "¿Pueden instalar antena parabólica para ver Canal Sur desde Argés?",
      answer: "Canal Sur se emite en TDT y se puede recibir perfectamente en Argés. Si lo que busca son canales que no están en TDT, podemos instalar una parabólica orientada al satélite adecuado."
    },
    {
...
export const metadata: Metadata = {
  title: `Antenista en Argés Toledo | ☎️ 668 67 95 00`,
...
export default function ArgesPage() {
  return (
    <>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="relative">
                  <div className="mt-20 flex justify-center relative overflow-hidden rounded-xl">
                    <Image src="/images/telecom/antenistas-en-toledo-sur.jpg" alt="Antenista profesional en Argés Toledo" width={400} height={200} priority />
                  </div>
                </div>
              </div>
            </div>
