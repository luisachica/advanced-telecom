...
export const metadata: Metadata = {
  title: `Antenista en Aldea del Fresno | Antenas Toledo`,
  ...
  keywords: `antenista Aldea del Fresno, antenas TDT Aldea del Fresno, instalación antenas , reparación antenas Aldea del Fresno, telecomunicaciones Aldea del Fresno`,
  alternates: {
