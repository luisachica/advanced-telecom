            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-brand-black text-lg max-w-lg">
                  Llevamos más de 25 años trabajando en el sector de las telecomunicaciones, ofreciendo instalación y reparación de antenas TDT, parabólicas, porteros automáticos y cámaras de vigilancia en Toledo y  .
                </p>
