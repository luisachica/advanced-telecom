...
// ==================================================================
export default function ContenidoLimpiezaFinObra({ data: serviceData }: { data: any }) {
  const actualSlug = "limpieza-fin-obra";
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-[#00b3d7] hover:bg-[#0095b3] text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20fin%20de%20obra" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-[#00b3d7] pl-4 italic text-[#5a7184]">"Transformamos cualquier espacio post-obra en un lugar limpio, seguro y listo para su uso inmediato."</div>
                <p className="text-[#5a7184]">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Eliminación de escombros pequeños y residuos de construcción", "Limpieza y desincrustación de suelos y superficies", "Limpieza a fondo de ventanas, cristales y marcos", "Limpieza de baños y cocinas, incluyendo sanitarios y electrodomésticos", "Retirada de manchas de pintura, yeso y cemento", "Aspirado y fregado de todas las áreas"].map((item, index) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/limpieza-fin-obra-cristales.webp")} alt="Limpieza fin de obra de cristales" width={300} height={400} className="w-full h-auto object-cover" /></div>
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/limpieza-fin-de-obra-equipo.webp")} alt="Equipo de limpieza trabajando" width={300} height={200} className="w-full h-auto object-cover" /></div>
                </div>
                <div className="mt-12">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/limpieza-fin-obra-suelo.webp")} alt="Suelo limpio tras obra" width={300} height={500} className="w-full h-auto object-cover" /></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nos especializamos en convertir espacios recién construidos o renovados en ambientes impecables y seguros.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
           <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-[#0a3b5c] leading-tight mt-4">Así garantizamos un acabado perfecto</h2>
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nuestro método de trabajo asegura una limpieza minuciosa y eficiente después de cualquier obra.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-[#0a3b5c] leading-tight mt-4">Resolvemos tus dudas sobre limpieza fin de obra</h2>
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Encuentra respuestas a las preguntas más comunes sobre nuestros servicios post-construcción.</p>
            </div>
            <div className="max-w-3xl mx-auto">
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-[#0a3b5c] leading-tight mt-4">La satisfacción de nuestros clientes lo dice todo</h2>
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Descubre por qué somos la elección número uno para la limpieza fin de obra.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-[#0a3b5c] leading-tight mt-4">Complementa tu limpieza</h2>
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Descubre otros servicios de limpieza profesional que podrían interesarte para mantener tus espacios impecables.</p>
            </div>
        ...
        <section className="w-full py-16 bg-gradient-to-r from-[#0a3b5c] to-[#00b3d7] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Listo para estrenar tu espacio sin rastro de obra?</h2>
                <p className="text-white/90 text-lg">Solicita un presupuesto sin compromiso y deja en manos expertas la limpieza post-construcción.</p>
                <div className="flex flex-wrap gap-4 pt-6">
                  <Button asChild className="bg-white hover:bg-gray-100 text-[#00b3d7] font-bold rounded-full px-8 py-6 shadow-lg shadow-black/20 transition-all hover:translate-y-[-2px]">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20fin%20de%20obra"><ArrowRight className="mr-2 h-5 w-5" /> Solicitar presupuesto ahora</a>
                  </Button>
