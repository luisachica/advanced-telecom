...
import { Check, Star, Phone, ArrowRight, Clock, Shield, Sparkles, Users, Wrench, ChevronDown, Camera, Wifi } from "lucide-react";
...
// --- Mapeador de Íconos ---
const iconMap = { Sparkles, Users, Clock, Shield, Wrench, Check, Star, Phone, ArrowRight, ChevronDown, Camera, Wifi };
...
// ==================================================================
export default function ContenidoCamarasSeguridad({ data: serviceData }: { data: any }) {
  const actualSlug = "camaras-seguridad";
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20c%C3%A1maras%20de%20seguridad" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      src="/images/telecom/camaras-seguridad.jpg"
                      alt="Instalación de cámaras de seguridad y videovigilancia en "
                      width={600}
                      height={400}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-brand-green pl-4 italic text-brand-black-light">"Proteja su hogar o negocio con sistemas de videovigilancia de última generación, instalados por profesionales con años de experiencia en el sector."</div>
                <p className="text-brand-black-light">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Instalación de cámaras IP y analógicas HD", "Sistemas de grabación y almacenamiento", "Cámaras con visión nocturna y detección de movimiento", "Acceso remoto desde dispositivos móviles", "Mantenimiento y soporte técnico", "Asesoramiento sobre normativa legal"].map((item, index) => (
        ...
        <section className="w-full py-16 bg-[#334155] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Necesita mejorar la seguridad de su hogar o negocio?</h2>
                <p className="text-white/90 text-lg">
                  Contáctenos hoy mismo para obtener un presupuesto personalizado y sin compromiso para la instalación de cámaras de seguridad adaptadas a sus necesidades específicas.
                </p>
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20c%C3%A1maras%20de%20seguridad" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <MunicipiosServicio 
          titulo="Servicio técnico de cámaras de seguridad en los siguientes municipios y urbanizaciones"
          descripcion="Ofrecemos instalación, reparación y mantenimiento de cámaras de seguridad en toda la Comunidad de  y Toledo."
        />
      </main>
      <Footer />
      <WhatsappFloating />
