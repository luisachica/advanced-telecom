    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20porteros%20autom%C3%A1ticos" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      ...
                      alt="Instalación de porteros automáticos Fermax en "
                      width={600}
                      height={400}
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20porteros%20autom%C3%A1ticos" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <MunicipiosServicio 
          ...
          descripcion="Ofrecemos instalación, reparación y mantenimiento de porteros automáticos en toda la Comunidad de  y Toledo."
        />
      </main>
      <Footer />
      <WhatsappFloating />
