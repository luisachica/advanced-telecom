...
import { Check, Star, Phone, ArrowRight, Clock, Shield, Sparkles, Users, Wrench, ChevronDown, Satellite } from "lucide-react";
...
// --- Mapeador de Íconos ---
const iconMap = { Sparkles, Users, Clock, Shield, Wrench, Check, Star, Phone, ArrowRight, ChevronDown, Satellite };
...
// ==================================================================
export default function ContenidoAntenasParabolicas({ data: serviceData }: { data: any }) {
  const actualSlug = "antenas-parabolicas";
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20parab%C3%B3licas" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      src="/images/telecom/antena-parabolica.jpg"
                      alt="Instalación de antenas parabólicas Televes en "
                      width={600}
                      height={400}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-brand-green pl-4 italic text-brand-black-light">"Ofrecemos soluciones profesionales para la instalación y orientación de antenas parabólicas, dándole acceso a canales internacionales y contenido exclusivo."</div>
                <p className="text-brand-black-light">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Instalación de antenas parabólicas individuales y colectivas", "Reorientación a diferentes satélites (Astra, Hispasat, Hotbird)", "Reparación de averías en sistemas satelitales", "Instalación de receptores y decodificadores", "Configuración de canales y paquetes", "Mantenimiento preventivo de sistemas"].map((item, index) => (
        ...
        <section className="w-full py-16 bg-[#334155] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Quiere acceder a canales internacionales?</h2>
                <p className="text-white/90 text-lg">
                  Contáctenos hoy mismo para obtener un presupuesto personalizado y sin compromiso para su instalación o reorientación de antenas parabólicas.
                </p>
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20parab%C3%B3licas" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        {/* Municipios donde ofrecemos el servicio */}
        <MunicipiosServicio />
      </main>
      <Footer />
      <WhatsappFloating />
