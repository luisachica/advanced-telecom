              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20parab%C3%B3licas" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      ...
                      alt="Instalación de antenas parabólicas Televes en Madrid"
                      width={600}
                      height={400}
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20parab%C3%B3licas" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
