...
import { Check, Star, Phone, ArrowRight, Clock, Shield, Sparkles, Users, ChevronDown, Building } from "lucide-react";
...
// ==================================================================
export default function ContenidoLimpiezaEmpresas({ data: serviceData }: { data: any }) {
  const actualSlug = "limpieza-empresas";
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-[#00b3d7] hover:bg-[#0095b3] text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20empresas" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-[#00b3d7] pl-4 italic text-[#5a7184]">"Transformamos cualquier espacio empresarial en un entorno impecable y acogedor, adaptándonos a las necesidades y horarios de cada negocio."</div>
                <p className="text-[#5a7184]">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Limpieza y desinfección de oficinas y despachos", "Mantenimiento de zonas comunes y áreas de recepción", "Limpieza de baños y cocinas industriales/corporativas", "Limpieza de suelos y superficies (todo tipo de materiales)", "Vaciado de papeleras y gestión de residuos", "Limpieza de cristales (interiores y exteriores)"].map((item, index) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-oficinas-general.webp")} alt="Limpieza de oficinas en empresa" width={300} height={400} className="w-full h-auto object-cover" /></div>
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-recepcion-empresa.webp")} alt="Limpieza de recepción de empresa" width={300} height={200} className="w-full h-auto object-cover" /></div>
                </div>
                <div className="mt-12">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-empresas-madrid.webp")} alt="Servicio de limpieza para empresas" width={300} height={500} className="w-full h-auto object-cover" /></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nuestro servicio se distingue por su calidad, profesionalidad y atención al detalle, garantizando un entorno de trabajo óptimo.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
           <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Seguimos un proceso estructurado para garantizar un servicio de calidad y adaptado a la envergadura de su empresa.</p>
            </div>
        ...
        <section className="w-full py-16 bg-gradient-to-r from-[#0a3b5c] to-[#00b3d7] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Listo para potenciar la imagen de tu empresa con una limpieza profesional?</h2>
                ...
                <div className="flex flex-wrap gap-4 pt-6">
                  <Button asChild className="bg-white hover:bg-gray-100 text-[#00b3d7] font-bold rounded-full px-8 py-6 shadow-lg shadow-black/20 transition-all hover:translate-y-[-2px]">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20empresas"><ArrowRight className="mr-2 h-5 w-5" /> Solicitar presupuesto ahora</a>
                  </Button>
