...
// --- Mapeador de Íconos ---
const iconMap = { Sparkles, Users, Clock, Shield, Building2, Check, Star, Phone, ArrowRight, ChevronDown };
...
// ==================================================================
export default function ContenidoLimpiezaComunidades({ data: serviceData }: { data: any }) {
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-[#00b3d7] hover:bg-[#0095b3] text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20comunidades" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-[#00b3d7] pl-4 italic text-[#5a7184]">"Ofrecemos soluciones de limpieza integrales para comunidades, garantizando un ambiente limpio y agradable para todos los residentes."</div>
                <p className="text-[#5a7184]">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Limpieza y desinfección de portales y escaleras", "Mantenimiento de ascensores y pasillos", "Limpieza de barandillas y pomos", "Aspirado y fregado de suelos", "Vaciado y limpieza de papeleras", "Limpieza de cristales y espejos en zonas comunes"].map((item, index) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-escaleras-comunidad.webp")} alt="Limpieza de escaleras de comunidad" width={300} height={400} className="w-full h-auto object-cover" /></div>
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-ascensor.webp")} alt="Limpieza de ascensor" width={300} height={200} className="w-full h-auto object-cover" /></div>
                </div>
                <div className="mt-12">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-comunidades-madrid.webp")} alt="Limpieza de portales y zonas comunes" width={300} height={500} className="w-full h-auto object-cover" /></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nuestro servicio se distingue por su calidad, profesionalidad y atención al detalle, garantizando espacios limpios y seguros para tu comunidad.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Seguimos un proceso estructurado para garantizar un servicio de calidad y adaptado a las necesidades de tu comunidad.</p>
            </div>
        ...
        <section className="w-full py-16 bg-gradient-to-r from-[#0a3b5c] to-[#00b3d7] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Listo para una comunidad más limpia y acogedora?</h2>
                <p className="text-white/90 text-lg">Solicita un presupuesto sin compromiso y descubre cómo nuestro servicio de {serviceData.title.toLowerCase()} puede mejorar el día a día de tu edificio.</p>
                <div className="flex flex-wrap gap-4 pt-6">
                  <Button asChild className="bg-white hover:bg-gray-100 text-[#00b3d7] font-bold rounded-full px-8 py-6 shadow-lg shadow-black/20 transition-all hover:translate-y-[-2px]">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20comunidades"><ArrowRight className="mr-2 h-5 w-5" /> Solicitar presupuesto ahora</a>
                  </Button>
