...
import { Check, Star, Phone, ArrowRight, Clock, Shield, Sparkles, Users, Wrench, ChevronDown, Radio } from "lucide-react";
...
// --- Mapeador de Íconos ---
const iconMap = { Sparkles, Users, Clock, Shield, Wrench, Check, Star, Phone, ArrowRight, ChevronDown, Radio };
...
// ==================================================================
export default function ContenidoAntenasTDT({ data: serviceData }: { data: any }) {
  const actualSlug = "antenas-tdt";
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20TDT" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
                  <div className="aspect-[3/2] relative">
                    <Image
                      src="/images/telecom/antena-tdt-instalacion-01.jpg"
                      alt="Instalación de antenas TDT profesionales en "
                      fill
                ...
                <div className="absolute -bottom-8 -right-8 -z-10">
                  <div className="bg-brand-green/15 rounded-full w-72 h-72 blur-3xl animate-pulse"></div>
                </div>
                <div className="absolute -top-4 -left-4 -z-10">
                  <div className="bg-blue-500/10 rounded-full w-32 h-32 blur-2xl"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-brand-green pl-4 italic text-brand-black-light">"Ofrecemos soluciones profesionales para la instalación y reparación de antenas TDT, garantizando la mejor calidad de imagen y sonido en su televisor."</div>
                <p className="text-brand-black-light">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Instalación de antenas individuales y colectivas", "Reparación de averías en sistemas de antenas", "Reorientación de antenas", "Amplificación de señal", "Adaptación a TDT HD y 4K", "Eliminación de interferencias"].map((item, index) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {serviceData.relatedServices.map((service: any, index: number) => (
                <div key={index} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3 group-hover:text-brand-green transition-colors duration-300">{service.title}</h3>
                    <div className="pt-4">
                      <Link href={service.link} className="inline-flex items-center text-brand-green hover:text-brand-green-dark font-semibold transition-all duration-300 group-hover:gap-3">
                        Ver servicio <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                      </Link>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full py-16 bg-[#334155] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Listo para mejorar la recepción de su televisor?</h2>
                <p className="text-white/90 text-lg">
                  Contáctenos hoy mismo para obtener un presupuesto personalizado y sin compromiso para su instalación o reparación de antenas TDT.
                </p>
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20antenas%20TDT" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <MunicipiosServicio 
          titulo="Servicio técnico de antenas TDT en los siguientes municipios y urbanizaciones"
          descripcion="Ofrecemos instalación, reparación y mantenimiento de antenas TDT en toda la Comunidad de  y Toledo."
        />
      </main>
      <Footer />
      <WhatsappFloating />
