...
// --- Mapeador de Íconos ---
const iconMap = { Sparkles, Shield, Check, Clock, Car, Star, Phone, ArrowRight, ChevronDown };
...
// ==================================================================
export default function ContenidoLimpiezaGarajes({ data: serviceData }: { data: any }) {
  const actualSlug = "limpieza-garajes";
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-[#00b3d7] hover:bg-[#0095b3] text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20más%20informaci%C3%B3n%20sobre%20limpieza%20de%20garajes" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-[#00b3d7] pl-4 italic text-[#5a7184]">"Especialistas en la limpieza profunda de garajes, eliminando suciedad, grasa y olores para un espacio impecable y seguro."</div>
                <p className="text-[#5a7184]">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Fregado industrial de suelos con maquinaria especializada", "Eliminación de manchas de aceite, grasa y rodaduras de neumáticos", "Limpieza de paredes, columnas, techos y tuberías", "Barrido y aspirado de polvo y residuos", "Limpieza de extintores, señalización y puntos de luz", "Vaciado y limpieza de sumideros y desagües"].map((item, index) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-parking-subterraneo.webp")} alt="Limpieza de parking subterráneo" width={300} height={400} className="w-full h-auto object-cover" /></div>
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/maquinaria-limpieza-garajes.webp")} alt="Maquinaria para limpieza de garajes" width={300} height={200} className="w-full h-auto object-cover" /></div>
                </div>
                <div className="mt-12">
                  <div className="rounded-2xl overflow-hidden shadow-md"><Image src={validateImagePath("/images/limpieza-garajes-madrid.webp")} alt="Limpieza de garajes en Madrid" width={300} height={500} className="w-full h-auto object-cover" /></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nos especializamos en la limpieza de garajes, ofreciendo soluciones efectivas para mantener estos espacios en óptimas condiciones.</p>
            </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
           <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-[#5a7184] text-lg max-w-2xl mx-auto mt-4">Nuestra metodología garantiza una limpieza exhaustiva y eficiente de tu garaje, paso a paso.</p>
            </div>
        ...
        <section className="w-full py-16 bg-gradient-to-r from-[#0a3b5c] to-[#00b3d7] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Listo para transformar tu garaje?</h2>
                <p className="text-white/90 text-lg">Solicita un presupuesto sin compromiso y descubre cómo nuestro servicio de {serviceData.title.toLowerCase()} puede dejar tu espacio impecable y seguro.</p>
                <div className="flex flex-wrap gap-4 pt-6">
                  <Button asChild className="bg-white hover:bg-gray-100 text-[#00b3d7] font-bold rounded-full px-8 py-6 shadow-lg shadow-black/20 transition-all hover:translate-y-[-2px]">
                    <a href="https://wa.me/34608305354?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20limpieza%20de%20garajes"><ArrowRight className="mr-2 h-5 w-5" /> Solicitar presupuesto ahora</a>
                  </Button>
