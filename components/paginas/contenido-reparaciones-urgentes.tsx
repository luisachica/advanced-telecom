              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20necesito%20una%20reparaci%C3%B3n%20urgente" target="_blank" rel="noopener noreferrer">Solicitar asistencia urgente</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      ...
                      alt="Servicio técnico de reparaciones urgentes 24/7 en "
                      width={600}
                      height={400}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-slate-800 leading-tight mt-4">
                Cómo trabajamos en <span className="text-green-600">Antenas Toledo</span>
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-slate-800 rounded-full px-8 py-6">
                    <a href="https://wa.me/34668679500?text=Hola%2C%20necesito%20una%20reparaci%C3%B3n%20urgente" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
