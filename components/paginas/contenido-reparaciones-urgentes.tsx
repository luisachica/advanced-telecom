...
// ==================================================================
export default function ContenidoReparacionesUrgentes({ data: serviceData }: { data: any }) {
  const actualSlug = "reparaciones-urgentes";
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20necesito%20una%20reparaci%C3%B3n%20urgente" target="_blank" rel="noopener noreferrer">Solicitar asistencia urgente</a>
                  </Button>
              ...
              <div className="relative">
                <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
                    <Image
                      ...
                      alt="Servicio técnico de reparaciones urgentes 24/7 en Madrid"
                      width={600}
                      height={400}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-green-600 pl-4 italic text-slate-600">"Solucionamos sus problemas de telecomunicaciones con rapidez y eficacia. Nuestro equipo de técnicos cualificados está disponible para atender emergencias cuando más lo necesita."</div>
                <p className="text-slate-600">{serviceData.longDescription}</p>
                <ul className="space-y-3">
                  {["Servicio disponible 24/7 para emergencias", "Reparación de antenas TDT y parabólicas", "Solución de averías en porteros automáticos", "Reparación de sistemas de videovigilancia", "Eliminación de interferencias en señal TV", "Presupuesto sin compromiso"].map((item, index) => (
                ...
                <div className="pt-4">
                  <Button asChild className="bg-green-600 hover:bg-green-700 text-white rounded-full px-8 py-6">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20necesito%20una%20reparaci%C3%B3n%20urgente" target="_blank" rel="noopener noreferrer">Solicitar asistencia urgente</a>
                  </Button>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-slate-800 leading-tight mt-4">
                Cómo trabajamos en <span className="text-green-600">Advanced Telecom</span>
              </h2>
        ...
        <section className="w-full py-16 md:py-24 bg-[#f8fafc]">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-600 text-lg max-w-2xl mx-auto mt-4">Descubre otros servicios de telecomunicaciones que podrían interesarte.</p>
            </div>
              ...
              {serviceData.relatedServices.map((service: any, index: number) => (
                <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <div className="pt-4">
                      <Link href={service.link} className="inline-flex items-center text-green-600 hover:text-green-700 font-medium">
        ...
        <section className="w-full py-16 bg-[#334155] relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">¿Tiene una emergencia en sus telecomunicaciones?</h2>
                <p className="text-white/90 text-lg">
                  No espere más. Contáctenos ahora mismo para una asistencia rápida y profesional. Estamos disponibles 24/7 para solucionar sus problemas urgentes.
                </p>
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-slate-800 rounded-full px-8 py-6">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20necesito%20una%20reparaci%C3%B3n%20urgente" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <MunicipiosServicio 
          titulo="Servicio técnico de reparaciones urgentes en los siguientes municipios y urbanizaciones"
          descripcion="Ofrecemos reparaciones urgentes de telecomunicaciones en toda la Comunidad de Madrid y Toledo."
        />
      </main>
      <Footer />
      <WhatsappFloating />
