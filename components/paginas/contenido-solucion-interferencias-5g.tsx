  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-brand-green hover:bg-brand-green-dark text-white rounded-full px-8 py-6 relative z-30">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20soluci%C3%B3n%20de%20interferencias%205G" target="_blank" rel="noopener noreferrer">Solicitar presupuesto</a>
                  </Button>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button asChild className="bg-white hover:bg-gray-100 text-brand-black rounded-full px-8 py-6">
                    <a href="https://wa.me/34668838415?text=Hola%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20soluci%C3%B3n%20de%20interferencias%205G" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <MunicipiosServicio 
          titulo="Solución de Interferencias 5G en Madrid"
          descripcion="Eliminamos las interferencias 5G en su señal de televisión en todos los municipios de Madrid. Nuestros técnicos especializados instalan filtros LTE profesionales para recuperar la calidad de imagen y sonido."
        />
      </main>
      <Footer />
      <WhatsappFloating />
